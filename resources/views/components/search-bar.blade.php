    ...
    <div class="flex items-center">
        ...
        <div class="relative w-auto flex">
            <input type="text" name="search" value="{{ request('search') }}" id="{{ $id }}" autocomplete="off"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-none rounded-l-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:w-64 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-indigo-500 dark:focus:border-indigo-500"
                placeholder="Search">
            <button type="submit"
